...
public class ExpandableLinearLayout extends LinearLayout {
    public boolean default_isAnimation=true;
    ...
    public void toggle() {
        if (expanded) {
            collapse(default_isAnimation);
        } else {
            expand(default_isAnimation);
        }
    }
    public void expand(){
        expand(true);
    ...
    public void expand(boolean isAnimation) {
        if (expanded) {
            return;
        }
        if(isAnimation){
    ...
    public void collapse(boolean isAnimation) {
        if (!expanded) {
            return;
        }
        if(isAnimation){
